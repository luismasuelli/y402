...
def payment_required(
    *,
    ...
    def middleware(app: Flask):
        """
        The new middleware function, directly to be used in a Flask
        application.
        ...
        def wsgi_app(environ, start_response):
            """
            The generated application function.
            :param environ: The WSGI environment.
            :param start_response: The WSGI function to start the response.
            """
